...
function Library:Initiate()
    ...
    if game.CoreGui:FindFirstChild'Dragonhub'then 
        game.CoreGui.Dragonhub:Destroy();
    end;
    local DragonhubFunctions={};
    ...
    function DragonhubFunctions:GetHelpSections()
        return HelpSections;
    end;
    ...
    function DragonhubFunctions:CreateOption()
    ...
    function DragonhubFunctions:CreateTab(ID,Name)
        local Tab={}
    ...
    local function Search()
        ...
        -- for i,v in next,game.CoreGui.Dragonhub.MainFrame.Sections:GetDescendants()do 
